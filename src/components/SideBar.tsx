...
function SideBar() {
  ...
  return (
    <div className="flex items-center h-screen flex-col p-2">
      ...
      {session && (
        <div
          className="flex items-center justify-center w-12 h-12 bg-[#343541] rounded-full cursor-pointer hover:bg-[#3a3b3f]"
        >
          <Menu>
            <MenuHandler>
              <Avatar
            ...
            <MenuList className="p-1 bg-gray-100 rounded-md hover:border-none" >
